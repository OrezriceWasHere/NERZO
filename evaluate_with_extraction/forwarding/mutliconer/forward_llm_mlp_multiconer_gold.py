...
def main():
    clearml_poc.clearml_init(task_name="MultiCoNER LLM+MLP forward GOLD",
                             project_name="multiconer_pipeline",
    ...
    cl_ds = Dataset.create(dataset_name=output_path, dataset_project="multiconer_pipeline")
