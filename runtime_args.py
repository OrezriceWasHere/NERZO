...
class ElasticsearchConnection(BaseModel):
    hosts: list[str] = Field(default_factory=lambda:get_env("ELASTICSEARCH_HOSTS", "http://dsigpu06:9200,http://dsigpu08:9200,http://dsigpu07:9200,http://dsicsgpu07:9200").split(","))
